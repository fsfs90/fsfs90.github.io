...
这种精准的定位问题，我猜并不是 ai 有过人的聪明，而是ai比搜索引擎能更好地理解关键词、然后匹配已有的技术文档。现在 ai 编程工具像一个精准的stackoverflow searchbar。这种匹配度的提升是肉眼可见的。

我不在公司上班了，不知道公司里是如何的，但是我感到这种效率的提升必然伴随程序员总数需求的下降，想到最近的裁员，然后想到下围棋的棋手的沮丧，没想到 ai 饶过谁，现在很快就轮到程序员的沮丧了，我已经很久没学编程的兴趣了，感觉提不起兴趣不知道为啥，好像是少了一点神秘感、高深感好像是。。。🥲 想到程序员的高工资，确实是很大的激励，用爱发电无法持久啊，按说棋手下棋虽然下不过 ai，但是可以向 ai 学习进步，棋手按说应该都爱好下棋，应该影响不了心情，其实没那么简单，轮到自己，我感到几十美元一个月的 ai 能做了，我在这方面就竞争不过 gpu 了，然后企业不需要那么多程序员，我就拿不到高薪了，我就没那么积极了。这是一条逻辑链上的。